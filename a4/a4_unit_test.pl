...
:- begin_tests(q9).
test('disarm 6', [nondet]) :-
	disarm([1,2,2,116,3,3,5,2,5,8,5,6,6,8,32,2],[3,5,11,4,37,1,4,121,3,3,14],[[[1, 2], [3]], [[2, 2], [4]], [[2, 3], [5]], [[5], [1, 4]], [[6], [3, 3]], [[3, 8], [11]]|_]); 	
	disarm([1,2,2,116,3,3,5,2,5,8,5,6,6,8,32,2],[3,5,11,4,37,1,4,121,3,3,14],[[[1, 2], [3]], [[2, 2], [4]], [[5], [1,4]], [[2,3], [5]], [[6], [3, 3]], [[3, 8], [11]]|_]).
:- end_tests(q9).
